...
export default {
  ...
  methods: {
    ...
    // 刷新x轴数据
    refreshTableDate () {
      this.$store.dispatch('refreshFun6', this.resOption)
      this.$store.dispatch('refreshTitleFun6', this.areaChoose.name + this.timeChoose.name + this.dataElementChoose.name)
    },
    refreshTableDate1 () {
      this.$store.dispatch('refreshXDateFun6', '年度')
    },
    refreshTableDate2 () {
      this.$store.dispatch('refreshXDateFun6', '地区')
    },
    refreshTableDate3 () {
      this.$store.dispatch('refreshXDateFun6', 'city')
    },
    refreshTableDate4 () {
      this.$store.dispatch('refreshXDateFun6', this.dataElementChoose)
    },
    // 确定事件
    pushForm: function () {
