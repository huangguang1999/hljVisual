...
export default {
  ...
  methods: {
    ...
    refreshTableDate () {
      ...
      this.$store.dispatch('refreshTitleFun3', this.areaChoose.name + this.timeChoose.name + this.dataElementChoose.name)
    },
    refreshTableDate1 () {
      this.$store.dispatch('refreshXDateFun3', '年度')
    },
    refreshTableDate2 () {
      this.$store.dispatch('refreshXDateFun3', '地区')
    },
    refreshTableDate3 () {
      this.$store.dispatch('refreshXDateFun3', 'city')
    },
    refreshTableDate4 () {
      this.$store.dispatch('refreshXDateFun3', this.dataElementChoose)
    },
    // 确定事件
    pushForm: function () {
