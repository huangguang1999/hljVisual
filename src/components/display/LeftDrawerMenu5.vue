...
export default {
  ...
  methods: {
    ...
    // 刷新x轴数据
    refreshTableDate () {
      this.$store.dispatch('refreshFun5', this.resOption)
      this.$store.dispatch('refreshTitleFun5', this.areaChoose.name + this.timeChoose.name + this.dataElementChoose.name)
    },
    refreshTableDate1 () {
      this.$store.dispatch('refreshXDateFun5', '年度')
    },
    refreshTableDate2 () {
      this.$store.dispatch('refreshXDateFun5', '地区')
    },
    refreshTableDate3 () {
      this.$store.dispatch('refreshXDateFun5', 'city')
    },
    refreshTableDate4 () {
      this.$store.dispatch('refreshXDateFun5', this.dataElementChoose)
    },
    // 确定事件
    pushForm: function () {
