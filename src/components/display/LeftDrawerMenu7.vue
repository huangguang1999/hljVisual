...
export default {
  ...
  methods: {
    ...
    // 刷新x轴数据
    refreshTableDate () {
      this.$store.dispatch('refreshFun7', this.resOption)
      this.$store.dispatch('refreshTitleFun7', this.areaChoose.name + this.timeChoose.name + this.dataElementChoose.name)
    },
    refreshTableDate1 () {
      this.$store.dispatch('refreshXDateFun7', '年度')
    },
    refreshTableDate2 () {
      this.$store.dispatch('refreshXDateFun7', '地区')
    },
    refreshTableDate3 () {
      this.$store.dispatch('refreshXDateFun7', 'city')
    },
    refreshTableDate4 () {
      this.$store.dispatch('refreshXDateFun7', this.dataElementChoose)
    },
    // 确定事件
    pushForm: function () {
