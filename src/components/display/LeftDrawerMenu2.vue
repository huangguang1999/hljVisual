...
export default {
  ...
  methods: {
    ...
    refreshTableDate () {
      ...
      this.$store.dispatch('refreshTitleFun2', this.areaChoose.name + this.timeChoose.name + this.dataElementChoose.name)
    },
    refreshTableDate1 () {
      this.$store.dispatch('refreshXDateFun2', '年度')
    },
    refreshTableDate2 () {
      this.$store.dispatch('refreshXDateFun2', '地区')
    },
    refreshTableDate3 () {
      this.$store.dispatch('refreshXDateFun2', 'city')
    },
    refreshTableDate4 () {
      this.$store.dispatch('refreshXDateFun2', this.dataElementChoose)
    },
    // 确定事件
    pushForm: function () {
